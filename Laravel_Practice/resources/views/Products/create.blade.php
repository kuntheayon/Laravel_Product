...
<div class="border-b border-gray-100 px-6 py-4 flex justify-between items-center bg-gray-50/50">
    <h2 class="text-xl font-bold text-gray-700">Add Products</h2>
...
<form action="{{ route('api.products.store') }}" method="POST" class="p-6 space-y-5" data-api-form data-redirect="{{ route('categories.index') }}">
    @csrf
