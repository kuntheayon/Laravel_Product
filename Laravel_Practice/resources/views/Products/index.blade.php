        ...
        <tbody class="divide-y divide-gray-100 text-sm text-gray-700">
            ...
            <tr class="hover:bg-slate-50/80 transition duration-100">
                ...
                <td class="px-6 py-4 space-x-2 flex items-center">
                    ...
                    <form action="{{ route('api.products.destroy', $product->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this category?');" class="inline" data-api-form data-redirect="{{ route('categories.index') }}">
                        @csrf
                        @method('DELETE')
