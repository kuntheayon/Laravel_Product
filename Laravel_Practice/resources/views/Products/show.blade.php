...
@section('page_title', 'fProduct Details')
...
<div class="p-6 space-y-6">
    ...
    <div class="pt-4 flex justify-end gap-3 border-t border-gray-100">
        <a href="{{ route('categories.edit', $product->id) }}" class="bg-amber-500 hover:bg-amber-600 text-white font-semibold text-sm px-5 py-2.5 rounded-md transition duration-150 shadow-sm cursor-pointer">
            Modify Record
        </a>
    </div>
